...
`make demo` 명령은 `.demo/` 디렉토리에 8개의 서로 다른 PDF를 생성합니다:
- **간단한 버전** (상세도 1.0): 한국어 및 영어로 최소한의 콘텐츠
- **표준 버전** (상세도 1.5): 한국어 및 영어로 중간 상세도
- **상세 버전** (상세도 2.0): 한국어 및 영어로 전체 콘텐츠
- **깔끔한 버전**: 기술 섹션 제외 ("detail" 태그 제외)
- **기술 전용 버전**: 기술 섹션만 포함 ("detail" 태그 포함)

이것은 상세도 수준과 태그가 CV 출력에 어떻게 영향을 미치는지 확인하는 좋은 방법입니다!
